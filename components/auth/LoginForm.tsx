...
export default function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        className="mt-2 w-full rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 px-5 py-3.5 text-lg font-semibold text-white shadow-lg shadow-blue-500/25 transition hover:brightness-105 active:translate-y-px"
        type="submit"
      >
        Log In
      </button>
      ...
      <button
        type="button"
        className="flex w-full items-center justify-center gap-3 rounded-2xl border border-slate-200 bg-white px-5 py-3.5 text-base font-semibold text-slate-700 transition hover:bg-slate-50"
      >
